...
if B ~= 0;
    ...
    succeed = 1; return
else; dispifz('	UL/DL successful!'); end
...
if B ~= 0;
    ...
    succeed = 1; return;
else; dispifz('	Deep copy successful!'); end
...
if diff ~= 0
    ...
    succeed = 1; return;
else; dispifz('	Simple slab set successful!'); end
...
if diff ~= 0
    ...
    succeed = 1; return;
else; dispifz('	GPU_setslab via matlab array upload successful!'); end
...
if diff ~= 0
    disperr('!!! GPU_setslab failed!');
    succeed = 1; return;
else; dispifz('	GPU_setslab via GPU array deepcopy successful!'); end
...
if b(1) == 1 % serial
    ...
    if mpi_amirank0(); disp(sprintf('RANK %i: %s', int32(b(2)), x)); end
end
